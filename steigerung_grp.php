<?php
session_start();
if (empty($_SESSION['Steig_Grp'])) {
    $_SESSION['Steig_Grp'] = 0;
}
...
<form method="post" action="steigerung_grp.php">
...
$wk_korrektur_block_bridge1=0; //$data_wk_korrektur_block[Grp_Bridge_1];
$wk_korrektur_block_bridge2=0; //$data_wk_korrektur_block[Grp_Bridge_2];

echo"<p class=\"kopf\" align=\"center\"><font size=\"10\"><b>Dezentrale-Steigerungen</font></b></p>";
