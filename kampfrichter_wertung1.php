...
<script type="text/javascript">
    ...
    var refreshId = setInterval(function() {
     ...
     $(document).ready(function() {
       $("#newkr1").load("JQuery/kr1_wertung.php");
       var refreshId = setInterval(function() {
          $("#newkr1").load('JQuery/kr1_wertung.php?' + 1*new Date());
       }, 1000);
    });
    ...
    // $(document).ready(function() {
    //     $("#TEST").load("JQuery/kr1_wertung.php");
    //     var refreshId = setInterval(function() {
    //         $("#TEST").load('JQuery/kr1_wertung.php?' + 1*new Date());
    //     }, 1000);
    // });
...
<body>
<form method="post" action="kampfrichter_wertung_1.php">
