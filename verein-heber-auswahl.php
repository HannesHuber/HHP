...
if($OnlineWk==1){
    ...
    $Text = "Vorsicht: Für Bundesliga Wettkämpfe ist die korrekte Athleten ID zwingend erforderlich!";
    echo '<div style="font-size:1.5em;color:#0e3c68;font-weight:bold; float:left; text-decoration: underline; padding: 1em;">'.$Text.'</div>';
    //echo '<b>Vorsicht: Für Bundesliga Wettkämpfe ist die korrekte Athleten ID zwingend erforderlich!</b>';
