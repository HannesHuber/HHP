...
echo"<col width=\"50\">
    ...
    if ($stammdaten['RelativArt'] == "3" && $_SESSION['MitAllem']==1){echo"<col width=\"100\">";}
    echo"
    <col width=\"50\">
    <col width=\"50\">";
...
echo"
  <th>M/W</th>
  <th>KöGw</th>";
  if ($stammdaten['RelativArt'] == "3" && $_SESSION['MitAllem']==1){echo"<th>IAT-Faktor</th>";}
  echo"
  <th>1.V R</th>
  <th>1.V S</th>
  <th>Los Nr.</th>";
     ...
     if($_SESSION['MitAllem']==1){
     	...
     	echo "</td>";
          ...
          if ($stammdaten['RelativArt'] == "3"){
               echo "<td>";
               echo round(iat_factor($dsatz['Alter'], $dsatz['Geschlecht'], $dsatz['Gewicht']), 4);
               echo "</td>";
          }
