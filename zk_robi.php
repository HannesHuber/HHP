...
$auswerte_Gruppe=0;						//Damit in Auswertung über alle Gruppen Ausgewertet wird
...
$Grp=$_SESSION['Aus_R_Grp'];
	...
	$heber_aus= dbBefehl("SELECT * FROM heber, auswertung_".$data_a_db['S_Db'].", heber_".$data_a_db['S_Db'].", verein
			...
			auswertung_".$data_a_db['S_Db'].".Platz_Robi = 0, auswertung_".$data_a_db['S_Db'].".Platz_Robi ASC
			");
