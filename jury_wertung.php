...
document.ontouchmove = function(event){
   ...
   $(document).ready(function() {
     $("#newkr1").load("JQuery/jury_wertung.php");
     var refreshId = setInterval(function() {
        $("#newkr1").load('JQuery/jury_wertung.php?' + 1*new Date());
     }, 500);
  });
...
<body>
<form method="post" action="jury_wertung.php">

<span id="HardwareAnweisung"></span>

<?php

include 'Outsorst/jury_pad_wertung_code.php';
