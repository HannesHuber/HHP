...
$finder = 1;
     ...
     $Id="Id" . $i;
     $G_A2_M="G_" . $ak . "_M" . $i;          //Ändern
     $G_A2_M_A="G_" . $ak . "_M_A" . $i;      //Ändern
...
echo"<tbody>";
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_A2_M\" size=\"1\" class=\"Auswahl\">";        //Ändern
...
$finder=1;
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_A2_W\" size=\"1\" class=\"Auswahl\">";
