...
echo"<tbody>";
      echo"<tr align=\"center\">";
         ...
         echo"<td>";
           ...
           if($dsatz[E_M] == "1")              //�nderung
           {
                 echo "M +105";

           }else{
                 echo "M -$dsatz[E_M]";        //�nderung
           }
...
$Bis=$time[year] - $d_Klasse[Bis];
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_E_M\" size=\"1\" class=\"Auswahl\">";
         ...
         $Auswahl = mysql_query("SELECT Gk_E_M
         ...
         $dataAuswahl = mysql_fetch_assoc($Auswahl);
                       ...
                       while($dataGruppen = mysql_fetch_assoc($Gruppen))
                       {
                                 ...
                                 if($dataGruppen[Gruppen]==$dataAuswahl[Gk_E_M])
                                 {
...
$finder=1;
     ...
     $Id="Id" . $b;
     $G_E_W="G_E_W" . $b;            //�nderung


     echo"<tbody>";

     if($dsatzW[E_W] != "")              //�nderung
     {
      ...
      echo"<tr align=\"center\">";
         ...
         echo"<td>";
           ...
           if($dsatzW[E_W] == "1")           //�nderung
           {
                 echo "W +75";

           }else{
                 echo "W -$dsatzW[E_W]";      //�nderung
           }
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_E_W\" size=\"1\" class=\"Auswahl\">";
         ...
         $Auswahl = mysql_query("SELECT Gk_E_W
                                 FROM gruppen_$data_a_db[S_Db]
                                 WHERE Id='$b'
                                 ");
         ...
         $dataAuswahl = mysql_fetch_assoc($Auswahl);
                       ...
                       while($dataGruppen = mysql_fetch_assoc($Gruppen))
                       {
                                 ...
                                 if($dataGruppen[Gruppen]==$dataAuswahl[Gk_E_W])
                                 {
