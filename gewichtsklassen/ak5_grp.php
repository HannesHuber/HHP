...
$finder = 1;
     ...
     $Id="Id" . $i;
     $G_A5_M="G_" . $ak . "_M" . $i;          //Ändern
     $G_A5_M_A="G_" . $ak . "_M_A" . $i;      //Ändern
...
echo"<tbody>";
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_A5_M\" size=\"1\" class=\"Auswahl\">";        //Ändern
...
$b = $b+1;
$finder=1;
$Bis=1900;                       //Da Frauen nur bis Ak5 gehen

     $Id="Id" . $b;
     $G_A5_W="G_" . $ak . "_W" . $b;            //Änderung
     ...
     echo "<td>";
          ...
          echo "<select name=\"$G_A5_W\" size=\"1\" class=\"Auswahl\">";
