...
echo"<p class=\"kopf\" id='page-break'><b>Beugestützen von Grp:" . $_SESSION['GrpAthEin'] . "</b></p>";
...
echo "<input type=\"text\" name='$Id' size=\"0\" style=\" display: none; \" value=\"".$dsatz['IdHeber']."\"readonly>";
 ...
 echo "<tr>";
     ...
     echo"<td>";
                 echo "<input type=\"text\" name='$V1' size=\"2\" value=\"".$dsatz['Beugestuetz']."\"> Wdh";
     echo"</td>";
 echo "</tr>";
