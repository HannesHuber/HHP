<?php
echo"<p class=\"kopf\" id='page-break'><b>30m Sprint von Grp:" . $_SESSION['GrpAthEin'] . "</b></p>";
...
echo "<input type=\"text\" name='$Id' size=\"0\" style=\" display: none; \" value=\"".$dsatz['IdHeber']."\"readonly>";
 ...
 echo "<tr>";
     ...
     echo"<td>";
                 echo "<input type=\"text\" name='$V1' size=\"2\" value=\"".$dsatz['Sprint']."\"> sek";
     echo"</td>";


     echo"<td>";
                 echo "<input type=\"text\" name='$V2' size=\"2\" value=\"".$dsatz['Sprint2']."\"> sek";
 ...
 if(isset($_POST['speichern']))
{
         ...
         $_POST['V2' . $i]=str_replace(",",".", $_POST['V2' . $i]);
                 ...
                 dbBefehl("UPDATE heber_".$data_a_db['S_Db']."
                              SET Sprint= '" . $_POST['V1' . $i] . "', Sprint2= '" . $_POST['V2' . $i] . "'
