<?php
echo"<p class=\"kopf\" id='page-break'><b>Anristen von Grp:" . $_SESSION['GrpAthEin'] . "</b></p>";
...
echo"<p class=\"notiz\"><b>Die Grp " . $_SESSION['GrpAthEin'] . " ist einheitlich vom Alter: " . $Alter . ". D.h. ist die
max. Wdh-Anzahl: " . $MaxWdh . "Wdh.</b></p>";
}
...
echo "<input type=\"text\" name='$Id' size=\"0\" style=\" display: none; \" value=\"".$dsatz['IdHeber']."\"readonly>";
 ...
 echo "<tr>";
    ...
    if($test==false){
     ...
     echo"<td>";
                 echo "<input type=\"text\" STYLE=\"$style; $stylezwei;\" name='$V1' size=\"2\" value=\"".$dsatz['Anristen']."\"> Wdh";
     echo"</td>";
 echo "</tr>";
